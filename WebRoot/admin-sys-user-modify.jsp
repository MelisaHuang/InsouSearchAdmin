...
<div class="all">
	...
	<div id="right">
		<div class="right-top">
			<span class="title-bar">&gt;&gt;系统管理&gt;&gt;后台用户 &gt;&gt;删改查用户
		...
		<div class="right-content">
			<div class="right-c2">
     <form name="searchForm" method="post" action="../insouadmin/admin-sys-user-search.jsp">
	...
	usermap = InsouManagerServImp.getManagerList();
               		...
               		<tbody>
                 		<tr class="t-tr0">
                    		<td align="center" valign="middle"><%=manager.getName()%></td>
                     		...
                     		<td align="center">
							<a href="../insouadmin/admin-sys-user-edit.jsp?managername=<%=manager.getName()%>">修改</a>
							|
