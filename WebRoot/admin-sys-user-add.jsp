...
<div class="all">
	...
	<div id="right">
		...
		<div class="right-content">
			<div class="right-c1">
			<form name="addUserform" method="post" action="controller/ManagerServlet">
			 <input name="operation" type="hidden" id="operation" value="add">
             	用户名 ：
             	<input type="text" name="managername" id="managername" autofocus="autofocus" required="required" style="margin-left:9px"/>*必填 
            	 <br /><br />
            	 密   码：
             	<input type="password" name="password" id="password" autofocus="autofocus" required="required" style="margin-left:24px" />*必填 
             	<br /><br />
             	确认密码：
             	<input type="password" name="repassword" autofocus="autofocus" required="required" />*必填 
             	<br /><br />
            	选择角色: 
             	<select name="role"  id="role" class="xla_k" id="select_k1" style="margin-left:8px;height:22px">
            	...
            	<input type="reset" value="重置" class="b-return" style="margin-right:206px;">    
              	<button class="b-return"><a href="admin_user.jsp" >返回</button>
        	</form>
			</div>
		</div>
	</div>
