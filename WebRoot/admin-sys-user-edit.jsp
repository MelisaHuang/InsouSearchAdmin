...
<div class="all">
	...
	<div id="right">
		...
		<div class="right-content">
			<div class="right-c1">
			<form name="editUserform" method="post" action="controller/ManagerServlet">
			<input name="operation" type="hidden" id="operation" value="edit">
			<%
         String managername = request.getParameter("managername"); 
   		 InsouManager manager = InsouManagerServImp.getManager(managername);
		 
     %>
             	<table width="95%" height="389" border="0">
			<tr>
				<td>&nbsp;</td>
				<td>管理者名： <label> <input name="managername" type="text"
						id="managername" value="<%=managername%>" readonly>
				</label></td>
				<td>&nbsp;</td>
			</tr>
