...
<link rel="stylesheet" type="text/css" href="css/admin-data-rubbish.css">
...
<div class="all">
	...
	<div id="right">
		<div class="right-top">
			<span class="title-bar">&gt;&gt;数据管理&gt;&gt;垃圾数据 
			</span>
			<div class="title-r">
			    <div class="bar-ab">
		...
		<div class="right-content">
			<div class="right-d2">
				<div class="input-w">
					<form>
						输入关键词
						<input type="text" value="" name="keyw">
						<input class="s-button" type="button" value="搜索" name="search">
					</form>
				</div>
				<div class="input-wc">
					<table class="rub-t">
						<tr>
						<td>IMG_0898.JPG</td><td>JPG</td><td>328KB</td>
						</tr>
						<tr>
						<td>IMG_0898.JPG</td><td>JPG</td><td>328KB</td>
						</tr>
				...
				<div class="input-w">
					<input class="s-button s-delete" type="button" value="确定删除" name="search">
				</div>
			</div>
		</div>
	</div>
